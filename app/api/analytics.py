...
def fraud_logs(
    ...
    return analytics_service.get_fraud_logs(
        page, limit, user_id, fraud_only, start_date, end_date, db
    )
...
def otp_logs(
    ...
    return analytics_service.get_otp_logs(
        page, limit, user_id, status, start_date, end_date, db
    )
...
def fraud_trend(
    ...
    return analytics_service.get_fraud_trend(
        start_date, end_date, page, limit, db
    )